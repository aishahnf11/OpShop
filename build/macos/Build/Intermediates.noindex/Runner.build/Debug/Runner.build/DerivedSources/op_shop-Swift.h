...
#ifndef OP_SHOP_SWIFT_H
#define OP_SHOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="op_shop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7op_shop11AppDelegate")
...
SWIFT_CLASS("_TtC7op_shop17MainFlutterWindow")
